...
`)
            ...
            if (!message.member.hasPermission("MANAGE_GUILD") && message.author.id !== '') return message.reply(`**${message.author.username}**, Sorry, You need permission \`Manage Guild\` to use this command!`);
